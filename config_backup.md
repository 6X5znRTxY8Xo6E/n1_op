...
# CONFIG_PACKAGE_kmod-pinctrl-sx150x is not set
...
# CONFIG_PACKAGE_kmod-random-tpm is not set
...
# CONFIG_PACKAGE_wifi-l1profile is not set
...
# CONFIG_PACKAGE_n2n_v2 is not set
...
# CONFIG_PACKAGE_homeassistant-src is not set
...
# CONFIG_PACKAGE_strace_libdw is not set
